/**
 * Navigation Header with Aligned Dropdowns - PropertyLend
 * 
 * Phase 2.3: Navigation Dropdown Fix
 * - Properly aligned dropdowns centered under parent items
 * - Visual connector arrows between dropdowns and navbar
...
} from '@/components/ui/navigation-menu-aligned'
...
interface HeaderAlignedProps {
  className?: string
}

export function HeaderAligned({ className }: HeaderAlignedProps) {
    ...
    >
      <div className="container mx-auto max-w-[1440px] px-4 lg:px-12 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          {/* Desktop Navigation with Aligned Dropdowns */}
          <div className="hidden lg:flex items-center gap-6">
            <NavigationMenuAligned>
              <NavigationMenuAlignedList>
                {navigation.map((item) => (
                  <NavigationMenuAlignedItem key={item.title}>
                    {item.items ? (
                      ...
                      <>
                        ...
                        <NavigationMenuAlignedContent>
                          <NavigationMenuDropdownContainer align="center">
