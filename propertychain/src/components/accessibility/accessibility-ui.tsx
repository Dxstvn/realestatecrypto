...
export function SkipLinkItem({ href, children, className }: SkipLinkProps) {
  return (
    <a
      href={href}
      className={cn(
...
export function SkipNavigationLinks() {
  return (
    <div className="skip-navigation">
      ...
      <SkipLinkItem href="#navigation">Skip to navigation</SkipLinkItem>
...
export function KeyboardNavigation({
  ...
  return (
    <div
      ...
      className={className}
      role="group"
      aria-orientation={orientation === 'grid' ? 'horizontal' : orientation}
    >
      {children}
    </div>
  )
...
export function LiveRegionComponent({
  children,
  mode = 'polite',
  atomic = false,
  relevant = 'additions',
...
export function ScreenReaderOnlyComponent({ children }: { children: React.ReactNode }) {
...
export function AccessibilityToolbarComponent() {
...
// Note: Components are exported with renamed identifiers to avoid conflicts
// with lib/accessibility exports. They are exported individually above.