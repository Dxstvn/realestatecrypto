/**
 * Fixed Navigation Menu Component
 ...
 * - Works with Radix UI primitives correctly
 */
  ...
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        // Add the visual connector arrow using pseudo-elements
        "before:absolute before:-top-[7px] before:left-1/2 before:-translate-x-1/2",
        "before:h-0 before:w-0",
        "before:border-[7px] before:border-transparent",
        "before:border-b-border",
        // Inner arrow for fill
        "after:absolute after:-top-[6px] after:left-1/2 after:-translate-x-1/2",
        "after:h-0 after:w-0",
